 ...
 * $Revision: 3 $
 * $Date: 14/10/03 4:54p $
 * @brief    NUC131 series WWDT driver header file
 *
 * @note
 *
...
/** @addtogroup NUC131_WWDT_Driver WWDT Driver
  @{
*/

/** @addtogroup NUC131_WWDT_EXPORTED_CONSTANTS WWDT Exported Constants
  @{
*/
/*---------------------------------------------------------------------------------------------------------*/
...
/*@}*/ /* end of group NUC131_WWDT_EXPORTED_CONSTANTS */
...
/*@}*/ /* end of group NUC131_WWDT_Driver */
