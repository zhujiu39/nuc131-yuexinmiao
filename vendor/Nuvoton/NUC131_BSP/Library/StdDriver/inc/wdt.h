 ...
 * @brief    NUC131 series WDT driver header file
 *
 * @note
 *
...
/** @addtogroup NUC131_WDT_Driver WDT Driver
  @{
*/

/** @addtogroup NUC131_WDT_EXPORTED_CONSTANTS WDT Exported Constants
  @{
*/
/*---------------------------------------------------------------------------------------------------------*/
...
/*@}*/ /* end of group NUC131_WDT_EXPORTED_CONSTANTS */
...
/*@}*/ /* end of group NUC131_WDT_Driver */
